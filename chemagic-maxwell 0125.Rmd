...
write_csv(present_WW_data, path = str_c('excel files/Weekly data to HHD/', '0125 lift station Rice', '.csv'), na = '') # output csv file
...
```{r maxchemcorr, fig.width=7, fig.height=5}
