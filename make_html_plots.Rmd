...
```{r copiesrna}
  ...
  concWW_plot <- plot_mean_sd_jitter(sample_var = extra_categories, exclude_sample = T, x_var = WWTP, ylabel = 'Genome copies/l Wastewater') 
...
ordered_plt1 <- plot_mean_sd_jitter(sample_var = str_c(extra_categories, '|NTC|Vaccine'), exclude_sample = T, x_var = WWTP, ascending_order = T, ylabel = 'Genome copies/l Wastewater')
