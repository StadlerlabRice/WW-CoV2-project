...
```{r percentreco}
  ...
  percentreco_plt <- plot_mean_sd_jitter(measure_var = 'Percentage_recovery_BCoV', target_filter = 'BCoV|BRSV', x_var = WWTP, ylabel = 'Percentage recovery of surrogate virus') 
...
plot_mean_sd_jitter(measure_var = 'Percentage_recovery_BCoV', WWTP_var = wwtp_manhole_names, exclude_WWTP = T, target_filter = 'BCoV|BRSV', x_var = WWTP, ylabel = 'Percentage recovery of surrogate virus') %>% print()
