...
```{r indn1}
plt_N1 <- {individual_plots(.data_to_plot = without_ntc, target_string = 'N1', plt.save = 'no') + 
    # ylim(N_ww) +
...
```{r indn2}
plt_N2 <- individual_plots(.data_to_plot = without_ntc, target_string = 'N2', plt.save = 'no') + 
    # ylim(N_ww) +
    scale_y_log10(labels = fancy_scientific, limits = N_ww)
...
```{r indpMMoV}
plt_pMMoV <- individual_plots(.data_to_plot = without_ntc, target_string = 'pMMoV')
```

#### Copies ww/BCoV by method
```{r indBCoV}
plt_BCoV <- individual_plots(.data_to_plot = without_ntc, target_string = 'BCoV')
```
...
```{r indN1_rna}
plt_N1_RNA <- individual_plots(target_string = 'N1', y_var = `Copies/uL RNA`, plt.save = 'no') +
