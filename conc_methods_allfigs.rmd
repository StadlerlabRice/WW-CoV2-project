...
```{r indBCoV}
plt_BCoV <- individual_plots(.data_to_plot = all_data_input, target_string = 'BCoV')
```
...
save_plot('cor_all', sv.folder = 'Correlation')
...
save_plot('cor_method', sv.folder = 'Correlation')
...
save_plot('cor_wwtp', sv.folder = 'Correlation')
...
save_plot('nodirect_cor_all', sv.folder = 'Correlation')
...
save_plot('nodirect-noelution_cor_all', sv.folder = 'Correlation')
...
save_plot('BCoV vs pMMoV cor_all', sv.folder = 'Correlation')
