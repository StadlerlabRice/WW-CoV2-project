...
read_these_sheets <- c( 'dd.WW13_727_N1/N2', 'WW41_727_BCoV_Std24')
title_name <- '727 Rice'

# Biobot_id sheet
bb_sheets <- c('Week 16 (7/27)')

# Extra categories for plotting separately (separate by | like this 'Vaccine|Troubleshooting')
extra_categories = 'Std|Control|e728' # for excluding this category from a plot, make the switch (exclude_sample = TRUE)
