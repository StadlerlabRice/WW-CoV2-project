...
# all the plotting functions plot data: "long_processed_minimal" by default
  ...
  concWW_plot <- plot_mean_sd_jitter(measure_var = 'Recovered', WWTP_fltr_var = wwtp_manhole_names, x_var = WWTP, ylabel = 'Genome copies/l Wastewater') 
...
plot_mean_sd_jitter(measure_var = 'Recovered', target_filter_var = 'BCoV|BRSV', x_var = WWTP, ylabel = 'Genome copies/l Wastewater') %>%  format_logscale_y() %>% print()
...
plot_mean_sd_jitter(measure_var = 'Recovered', WWTP_fltr_var = wwtp_manhole_names, exclude_WWTP = T, x_var = WWTP, ylabel = 'Genome copies/l Wastewater') %>% 
...
plot_mean_sd_jitter(measure_var = 'Percentage_recovery_BCoV', WWTP_fltr_var = wwtp_manhole_names, exclude_WWTP = T, target_filter_var_var = 'BCoV|BRSV', x_var = WWTP, ylabel = 'Percentage recovery of surrogate virus') %>% print()
...
```{r percentRecoverystreamlined}
  ...
  recostr_plot <- plot_mean_sd_jitter(measure_var = 'Percentage_recovery_BCoV', x_var = WWTP, ascending_order = T, ylabel = 'Percentage recovery of surrogate')
